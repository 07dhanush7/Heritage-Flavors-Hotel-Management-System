    ...
    <div className="admin-main">
      <div className="admin-sidebar">
        ...
        <ul>
          ...
          <li onClick={() => navigate("/admin/resorts")} className="active">Resort Bookings</li>
      ...
      <div className="admin-content">
        <h1>Resort Bookings Information</h1>

        <div className="table-section">
          <h3>All Resort Bookings</h3>
          {resortBookings.length === 0 ? (
            <p>No resort bookings yet</p>
          ) : (
